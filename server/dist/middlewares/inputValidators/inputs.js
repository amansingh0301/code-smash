...
exports.submitContestInput = exports.checkAnswerInput = exports.fetchQuestionInputs = exports.fetchQuestionsInputs = exports.tokenInputs = void 0;
const express_validator_1 = require("express-validator");
exports.tokenInputs = [
    (0, express_validator_1.body)('reqId').exists().withMessage('reqId should be present'),
...
exports.submitContestInput = [
    (0, express_validator_1.body)('reqId').exists().withMessage('reqId should be present'),
    (0, express_validator_1.body)('questionResponseMap').exists().withMessage('questionResponseMap is Required'),
    (0, express_validator_1.body)('type').exists().withMessage('type is Required')
];
